...
screen_width = math.floor(infoObject.current_w * 0.5)
screen_height = math.floor(infoObject.current_h * 0.5)
win = pygame.display.set_mode((screen_width, screen_height), pygame.RESIZABLE)

pygame.display.set_caption("Snake : Competitive")
...
def level_3():
    global outer_points , pointlist, init_x, init_y

    #the outer layer points
    outer_points = []
...
def level_2():
    ...
    #the outer layer
    outer_points = []
    outer_points.append([(0, screen_height/3), (0,0),  (screen_width/5, 0)])
    outer_points.append([(screen_width - (screen_width/5),0),  (screen_width, 0), (screen_width, screen_height/3)])
    outer_points.append([(screen_width,screen_height - screen_height/3), (screen_width, screen_height),  (screen_width - screen_width/5, screen_height)])
    outer_points.append([(screen_width/5, screen_height), (0,screen_height),  (0, screen_height - screen_height/3)])
    outer_points.append([(screen_width/4, screen_height/3), (screen_width - screen_width/4, screen_height/3)])
    outer_points.append([(screen_width/4, screen_height - screen_height/3), (screen_width - screen_width/4, screen_height - screen_height/3)])
...
def level_1():
    global outer_points, pointlist, init_x, init_y
    outer_points = []
    outer_points.append([(0,0),  (screen_width, 0), (screen_width, screen_height), (0,screen_height), (0,0)])
    del(pointlist)
    pointlist = [(init_x, init_y)]
    return
...
def food():
    global a,b, food_count, side , threshhold, x, y, pointlist
    ...
    if (pygame.Surface.get_at(win, (a,b))) == (0,0,0,255):
        ...
        if food_count < threshhold:
            level_0()
        elif food_count == threshhold:
            level_1()
        elif food_count == 2 * threshhold :
            level_2()
        elif food_count == 3 * threshhold :
            level_3()
        elif food_count == 4 * threshhold :
            threshhold*=2
            food_count = 0
...
if __name__=='__main__' :
    ...
    init_x = 20
    init_y = int(screen_height/2)

    #one step and delay : This will define the speed of the snake
    step = side
    delay = 50
